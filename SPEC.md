...
- `/`: index (public)
- `/admin`: auth required → [Auth Spec](./src/app/api/auth/SPEC.md)
...
- Auth → [Spec](./src/app/api/auth/SPEC.md)
- Server Actions → [DB Spec](./src/db/SPEC.md)
- DB → [Spec](./src/db/SPEC.md)

## TBD

- Wedding details (date, time, venue, greeting)
